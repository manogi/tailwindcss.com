...
### Remove mode from configuration

If you were already using the JIT mode in your project, you had to add `mode: 'jit'` to your config file. This can now be removed:
